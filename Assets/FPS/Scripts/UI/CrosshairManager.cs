...
namespace Unity.FPS.UI
{
    ...
    public class CrosshairManager : MonoBehaviour
    {
        ...
        private void UpdateCrosshairPointingAtEnemy(bool force)
        {
            ...
            //기본상태에서 적을 포착하는 순간
            if ((force || !wasPointingAtEnemy) && weaponManager.IsPointingAtEnemy)
            {
                ...
                //crosshairImage.color = currentCrosshair.crosshairColor;
            }
            else if((force || wasPointingAtEnemy) && !weaponManager.IsPointingAtEnemy)
            {
